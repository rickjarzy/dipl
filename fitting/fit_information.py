...
fit_info_poly["lin_poly_lin_win15.weights.1_0.5_0.25_0.01_q0.01"] = {"algo_desc": "calculates first a linear regresion on all NaN Pixels and then perfomrs twice a Poly Fit with "
                                                                             "updateing the weights and uses lin for Nan Values in the end", "weights":"yes", "files_list":[], "fit_method_name":"Polynomial Fit"}
...
fit_info_best["dft.elements_3.1.00_0.50_0.25_0.01"] = {"algo_desc": "calculate discrete fourier transform with three elements for entire year", "weights":"yes", "files_list":[]}
fit_info_best["dft.elements_3.1.00_0.01_0.01_0.01"] = {"algo_desc": "calculate discrete fourier transform with three elements for entire year", "weights":"yes", "files_list":[]}
...
fit_info_best["poly_lin_win15.weights.1_0.5_0.01_0.01"] = {"algo_desc":"calculates a double poly fit with a SG window first and then a lin interpolation", "weights":"yes", "files_list":[]}
